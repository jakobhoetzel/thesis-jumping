...
class RolloutStorage:
    def __init__(self, num_envs, num_transitions_per_env, actor_run_obs_shape,
    ...
    def add_transitions(self, actor_run_obs, critic_run_obs,
                        actions, est_in, robotState, rewards, dones, values, actions_log_prob):
    ...
    def mini_batch_generator_shuffle(self, num_mini_batches):
        ...
        yield actor_run_obs_batch, critic_run_obs_batch, actions_batch, values_batch, est_in_batch, robotState_batch, \
