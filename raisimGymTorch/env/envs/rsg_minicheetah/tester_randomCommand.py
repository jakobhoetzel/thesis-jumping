...
if False:  # weight_path == "":
    ...
    for step in range(max_steps):
        ...
        concatenated_obs_actor_jump_old = concatenated_obs_actor_jump #for gradient calculation
        concatenated_obs_critic_run_old = concatenated_obs_critic_run
        ...
        concatenated_obs_critic_run = np.concatenate((obs_run, est_out_run.cpu().detach().numpy()),
                                                     axis=1)  # in case of run different
        ...
        reward_ll, dones = env.step(action_ll.detach().numpy(), run_bool=run_bool.detach().numpy().astype(bool),
